...
export default function Projects() {
    ...
    return (
        <section id="projects" className={"flex flex-col items-center justify-center px-50 py-45 pb-75 text-center "}>
            <h2 className={"text-4xl justify-center items-center px-15 bg-white/10 border-none rounded-4xl h-24 min-w-1/4 inline-flex font-jost font-semibold"}>
                My Projects
            </h2>
            <div className="pt-20 pb-20 w-full">
                ...
                <Collapsible open={isOpen} onOpenChange={setIsOpen} className="mt-8">
                    <CollapsibleContent className={"flex gap-8 justify-center w-full pb-20"}>
                        <ProjectCard
                            title="Wise Waste"
                    ...
                    <CollapsibleTrigger asChild>
                        <Button variant="outline" className={"mb-4 bg-white/15 border-white/5 shadow-2xl/50 hover:bg-white/30 rounded-4xl font-handjet text-xl font-light"}>
